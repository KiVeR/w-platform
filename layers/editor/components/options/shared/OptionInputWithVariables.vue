...
<template>
  <div class="option-input-with-variables">
    <div class="input-row">
...
.input-wrapper .option-input:focus {
  outline: none;
  border-color: var(--color-primary);
  box-shadow: var(--focus-ring);
}

.input-wrapper .option-input::placeholder {
