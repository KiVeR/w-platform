You are an impartial arbiter resolving 4 expert reviews of a landing page.

## Input
Read these 4 critique files:
...
## Voting rules
1. For each proposed modification across all 4 reviews:
...
4. Calculate overall LP score (average of all 4 reviewers' average scores)
