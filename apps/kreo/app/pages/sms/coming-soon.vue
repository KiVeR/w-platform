  ...
  <div class="coming-soon">
    <div class="coming-soon__card">
      ...
      <p class="coming-soon__description">
        L'éditeur de campagnes SMS est en cours de développement.
        Vous pourrez bientôt créer des messages texte optimisés
        avec gestion des variables et prévisualisation en temps réel.
      </p>

      <NuxtLink to="/dashboard" class="coming-soon__button">
        <ArrowLeft :size="18" />
